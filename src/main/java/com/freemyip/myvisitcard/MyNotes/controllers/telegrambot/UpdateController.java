...
import com.freemyip.myvisitcard.MyNotes.services.RegistrationService;
    ...
    private void helpAction(Update update, UserStatus userStatus) {
        ...
        createSendMessage(update,
                """
                        ...
                        Additionally, we were unable to implement a suitable method for editing notes through the bot, so you can edit notes via the website - https://myvisitcard.freemyip.com.
                        ...
                        Также не удалось реализовать приемлемый способ редактирования заметки через бота, поэтому отредактировать заметку можно через сайт - https://myvisitcard.freemyip.com.
